...
```html
<script
  src="https://unpkg.com/algosdk@vv5.5.22-beta.1/dist/browser/algosdk.min.js"
...
```html
<script
  src="https://cdn.jsdelivr.net/npm/algosdk@vv5.5.22-beta.1/dist/browser/algosdk.min.js"
  integrity="sha384-vb9VngcgEwkDszQ4wPAsk/oiOfBcbEjNG+Icx9erSJMLZCDPNp0ncx22oBM+8Xji"
  crossorigin="anonymous"
></script>
```
